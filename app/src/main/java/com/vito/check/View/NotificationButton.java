...
public class NotificationButton extends RadioButton {
    ...
    public NotificationButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.setButtonDrawable(new ColorDrawable(Color.TRANSPARENT));
        initProperty(context, attrs);
    }
...
//                rectF = new RectF(getWidth() - redCircleSize * 2, 0, getWidth(), redCircleSize * 2);
                rectF = new RectF(getWidth()/2+redCircleSize, 0, getWidth()/2+redCircleSize*3, redCircleSize * 2);
            }
        }
